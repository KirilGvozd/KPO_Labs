...
#error Возможно проведение только одного теста
        ...
        Entry e1 = { 1, "Блинова" }, e2 = { 2, "Гринюк" }, e3 = { 3, "Смелов" }, e4 = { 4, "Урбанович" }, e5 = { 5, "Пацей" }, e6 = { 6, "Жук" }, e7 = { 7, "Белый Дед" };
        AddEntry(d1, e1);
        AddEntry(d1, e2);
        AddEntry(d1, e3);
        AddEntry(d1, e4);
        ...
        Entry s1 = { 1, "Бекиш" }, s2 = { 2, "Гвоздовский" }, s3 = { 4, "Козак" }, s4 = { 5, "Смирнов" }, s5 = { 6, "Радивоник" }, s6 = { 7, "Климович" };
        AddEntry(d2, s1);
        AddEntry(d2, s2);
        AddEntry(d2, s3);
        AddEntry(d2, s4);
